 ...
 */
int main(){
    std::string result1 = make_prediction_json("./test/fa_examples/6999_3#3.fa.gz");
    std::string result2 = make_prediction_json("./test/fa_examples/6999_3#5.fa.gz");
    std::string test_result = result1+result2;

    std::ifstream testfile("./test/fa_examples/test_result.txt");
